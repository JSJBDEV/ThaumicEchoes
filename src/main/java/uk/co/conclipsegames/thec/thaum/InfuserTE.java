...
public class InfuserTE {
    public static void RegisterInfuser()
    {
        ...
        RecipesInfuser.addInfusing(new ItemStack(ModItems.xpcharm),50,RecipesInfuser.createPredicateFromResearches(ResearchesTE.xpstore),ItemMultiMaterial.EnumMultiMaterialType.EXTRACT_PUREST_MAGIC.stack(),ItemMultiMaterial.EnumMultiMaterialType.INTACT_TAINTSPORE_POD.stack(),new ItemStack(Items.GLASS_BOTTLE));
        RecipesInfuser.addInfusing(new ItemStack(ModItems.deathTag),60,RecipesInfuser.createPredicateFromResearches(ResearchesTE.rebirth),ItemMultiMaterial.EnumMultiMaterialType.EXTRACT_PUREST_MAGIC.stack(),ItemMultiMaterial.EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack(),ItemMultiMaterial.EnumMultiMaterialType.TOME_FORBIDDEN_KNOWLEDGE.stack(),ItemMultiMaterial.EnumMultiMaterialType.INHUMAN_SKULL.stack(),ItemMultiMaterial.EnumMultiMaterialType.EXTRACT_FOULEST_TAINT.stack());


        RecipesInfuser.addInfusing(new ItemStack(ModItems.sceptreDislocation),50,RecipesInfuser.createPredicateFromResearches(ResearchesTE.sceptre),ItemMultiMaterial.EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack(),new ItemStack(ItemsLT.SINGULARITY),new ItemStack(ItemsLT.VOID_COMPASS),ItemMultiMaterial.EnumMultiMaterialType.TAINTED_BRANCH.stack(),ItemMultiMaterial.EnumMultiMaterialType.EXTRACT_PUREST_MAGIC.stack());
        RecipesInfuser.addInfusing(new ItemStack(ModItems.sceptreUprising),50,RecipesInfuser.createPredicateFromResearches(ResearchesTE.sceptre),ItemMultiMaterial.EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack(),new ItemStack(ItemsLT.SINGULARITY),new ItemStack(ItemsLT.ELEMENTAL_SWORD),ItemMultiMaterial.EnumMultiMaterialType.TAINTED_BRANCH.stack(),ItemMultiMaterial.EnumMultiMaterialType.EXTRACT_LIGHTEST_AIR.stack());
        RecipesInfuser.addInfusing(new ItemStack(ModItems.sceptreFreezing),50,RecipesInfuser.createPredicateFromResearches(ResearchesTE.sceptre),ItemMultiMaterial.EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack(),new ItemStack(ItemsLT.SINGULARITY),new ItemStack(Blocks.ICE),ItemMultiMaterial.EnumMultiMaterialType.TAINTED_BRANCH.stack(),ItemMultiMaterial.EnumMultiMaterialType.EXTRACT_COOLEST_WATER.stack());
        RecipesInfuser.addInfusing(new ItemStack(ModItems.sceptreHellfire),50,RecipesInfuser.createPredicateFromResearches(ResearchesTE.sceptre),ItemMultiMaterial.EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack(),new ItemStack(ItemsLT.SINGULARITY),new ItemStack(Blocks.MAGMA),ItemMultiMaterial.EnumMultiMaterialType.TAINTED_BRANCH.stack(),ItemMultiMaterial.EnumMultiMaterialType.EXTRACT_WARMEST_FIRE.stack());

...
public class InfuserTE {
    public static void RegisterInfuser()
    {
        ...
        RecipesInfuser.addInfusing(new ItemStack(ModItems.sceptreDislocation),50,RecipesInfuser.createPredicateFromResearches(ResearchesTE.sceptre),ItemMultiMaterial.EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack(),new ItemStack(ItemsLT.SINGULARITY),new ItemStack(ItemsLT.VOID_COMPASS),ItemMultiMaterial.EnumMultiMaterialType.DISTURBING_MIRROR.stack(),ItemMultiMaterial.EnumMultiMaterialType.EXTRACT_PUREST_MAGIC.stack());
        RecipesInfuser.addInfusing(new ItemStack(ModItems.sceptreUprising),50,RecipesInfuser.createPredicateFromResearches(ResearchesTE.sceptre),ItemMultiMaterial.EnumMultiMaterialType.ENCHANTED_SILVERWOOD.stack(),new ItemStack(ItemsLT.SINGULARITY),new ItemStack(ItemsLT.ELEMENTAL_SWORD),ItemMultiMaterial.EnumMultiMaterialType.WORN_STATUETTE.stack(),ItemMultiMaterial.EnumMultiMaterialType.EXTRACT_LIGHTEST_AIR.stack());
